      ...
      <header className="sticky top-0 z-30 border-b border-brand-pearl/10 bg-brand-black/20 backdrop-blur-xl">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <ThemeToggle compact />
            <Link to="/manager/login" className="inline-flex items-center justify-center gap-2 rounded-full border border-brand-pearl/20 bg-brand-martinique/45 px-4 py-2 text-xs font-bold uppercase tracking-[0.14em] text-brand-peach transition hover:border-brand-studio hover:bg-brand-studio/70"><FontAwesomeIcon icon={faUserShield} /> Manager</Link>
          </div>
        </div>
      </header>
